...
- (UILabel *)wechatLabel
{
    if (_wechatLabel == nil) {
        ...
        _wechatLabel.text = [WKAccountInfo sharedInstance].uniqueName;
    }
    return _wechatLabel;
}
...
- (UILabel *)sexLabel
{
    if (_sexLabel == nil) {
        ...
        _sexLabel.text = [WKAccountInfo sharedInstance].sex;
    }
    return _sexLabel;
}
...
- (UILabel *)signatureLabel
{
    if (_signatureLabel == nil) {
        ...
        _signatureLabel.text = [WKAccountInfo sharedInstance].signature;
    }
