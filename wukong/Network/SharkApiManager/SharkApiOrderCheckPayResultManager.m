//
//  SharkApiOrderCheckPayResultManager.m
//  customer-ios
//
...
#import "SharkApiOrderCheckPayResultManager.h"

@implementation SharkApiOrderCheckPayResultManager
...
- (NSString *)methodName
{
    return @"api.order.check.pay.result";
}
